...
export const skillCategories: SkillCategory[] = [
  {
    ...
    iconName: 'Server',
    skills: [
      { name: 'Java', level: 'Advanced', featured: true, description: 'Core Java, Multithreading, Memory Optimization' },
      { name: 'Spring Boot', level: 'Advanced', featured: true, description: 'REST, Auto-config, Spring Security, Actuator' },
      { name: 'Microservices', level: 'Advanced', featured: true, description: 'Distributed System Design, Service Mesh, REST APIs' },
      { name: 'Spring Data JPA / Hibernate', level: 'Advanced', featured: true, description: 'ORMs, Batch processing, Query tuning' },
      { name: 'Multithreading & Concurrency', level: 'Advanced', featured: true, description: 'Java Executor framework, Parallel streams' },
      { name: 'System Design & Data Structures', level: 'Advanced', featured: true, description: 'Scalable architecture, Clean Architecture' },
    ],
  },
  {
    ...
    iconName: 'Cloud',
    skills: [
      { name: 'Kubernetes (K8s)', level: 'Advanced', featured: true, description: 'EKS, Pod auto-scaling, Distributed job scheduling' },
      { name: 'AWS Cloud', level: 'Advanced', featured: true, description: 'AWS EKS, S3, EC2, RDS, Lambda' },
      { name: 'Docker', level: 'Advanced', featured: true, description: 'Multi-stage builds, Containerization' },
      { name: 'Jenkins & CI/CD', level: 'Advanced', featured: true, description: 'Automated pipelines, WAR packaging, Blue-Green deploy' },
      { name: 'Git & Maven', level: 'Advanced', description: 'Version control, Multi-module Maven builds' },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'PostgreSQL & MySQL', level: 'Advanced', featured: true, description: 'Complex joins, Index tuning, Partitioning' },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'HTML5 & CSS3', level: 'Advanced', description: 'Responsive design, Flexbox, CSS Grid' },
  ...
  },
  {
    ...
    skills: [
      { name: 'Zero Trust IAP', level: 'Advanced', featured: true, description: 'Identity Aware Proxy, Fine-grained access control' },
      { name: 'SiteMinder & LDAP', level: 'Advanced', description: 'Enterprise IdP, Single Sign-On (SSO)' },
      { name: 'Splunk & CloudWatch', level: 'Advanced', featured: true, description: 'Distributed tracing, Log analytics, Alerting' },
      { name: 'JWT & OAuth2', level: 'Advanced', description: 'Stateless session tokens, API security' },
    ],
  },
];
